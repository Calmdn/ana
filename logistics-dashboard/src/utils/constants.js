...
// 城市列表
export const CITIES = [
  { label: '北京', value: 'beijing', code: '110000' },
  { label: '上海', value: 'shanghai', code: '310000' },
  { label: '广州', value: 'guangzhou', code: '440100' },
  { label: '深圳', value: 'shenzhen', code: '440300' },
  { label: '杭州', value: 'hangzhou', code: '330100' },
  { label: '南京', value: 'nanjing', code: '320100' },
  { label: '武汉', value: 'wuhan', code: '420100' },
  { label: '成都', value: 'chengdu', code: '510100' },
  { label: '重庆', value: 'chongqing', code: '500000' },
  { label: '西安', value: 'xian', code: '610100' },
  { label: '天津', value: 'tianjin', code: '120000' },
  { label: '苏州', value: 'suzhou', code: '320500' },
  { label: '青岛', value: 'qingdao', code: '370200' },
  { label: '郑州', value: 'zhengzhou', code: '410100' },
  { label: '大连', value: 'dalian', code: '210200' },
  { label: '宁波', value: 'ningbo', code: '330200' }
]
...
export const ALERT_TYPES = {
  DELIVERY_DELAY: { label: '配送延迟', value: 'DELIVERY_DELAY', icon: 'Timer' },
  ROUTE_DEVIATION: { label: '路径偏移', value: 'ROUTE_DEVIATION', icon: 'Location' },
  TRAFFIC_CONGESTION: { label: '交通拥堵', value: 'TRAFFIC_CONGESTION', icon: 'Warning' },
  VEHICLE_BREAKDOWN: { label: '车辆故障', value: 'VEHICLE_BREAKDOWN', icon: 'Tools' },
  WEATHER_IMPACT: { label: '天气影响', value: 'WEATHER_IMPACT', icon: 'Cloudy' },
  CAPACITY_OVERLOAD: { label: '运力超载', value: 'CAPACITY_OVERLOAD', icon: 'Box' },
  SYSTEM_ERROR: { label: '系统异常', value: 'SYSTEM_ERROR', icon: 'Monitor' },
  SECURITY_ISSUE: { label: '安全问题', value: 'SECURITY_ISSUE', icon: 'Lock' }
}
